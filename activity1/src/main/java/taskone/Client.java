...
public class Client {
     ...
     */
    public static JSONObject add(Socket sock) {
     ...
     */
    public static JSONObject pop(Socket sock) {
		StringList strings = new StringList();
		Performer performer = new Performer(sock, strings);
        String strToSend = null;
        int inNum;
     ...
     */
    public static JSONObject display(Socket sock) {
		StringList strings = new StringList();
		Performer performer = new Performer(sock, strings);
        JSONObject request = new JSONObject();
        request.put("selected", 3);
		request.put("data", performer.display());
        return request;
    }
     ...
     */
    public static JSONObject count(Socket sock) {
		StringList strings = new StringList();
		Performer performer = new Performer(sock, strings);
        JSONObject request = new JSONObject();
        request.put("selected", 4);
        request.put("data", performer.count());
        return request;
    }
